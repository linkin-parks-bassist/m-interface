...
typedef m_int_profile_ptr_linked_list profile_ll;
...
typedef struct
{
	...
	m_int_profile *working_profile;
	m_int_profile *active_profile;
	m_int_profile *default_profile;
