...
int create_sequence_list_ui(m_int_ui_page *page);
int free_sequence_list_ui(m_int_ui_page *page);
int enter_sequence_list(m_int_ui_page *page);
int refresh_sequence_list(m_int_ui_page *page);

struct m_int_menu_item *create_sequence_listing_menu_item(char *text, m_int_sequence *sequence, m_int_ui_page *parent);
